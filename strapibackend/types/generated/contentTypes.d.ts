...
export interface ApiBooksCollectionBooksCollection
  ...
  attributes: {
    ...
    Book_Image: Attribute.Media & Attribute.Required;
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::books-collection.books-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::books-collection.books-collection': ApiBooksCollectionBooksCollection;
